...
import 'package:untitled/Activities/asset_verification.dart';
                    ...
                    GestureDetector(
                      ...
                      onTap: () {
                         Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const AssetVerification()
                                    ));
                      },
                      child: Card(
                          color: const Color(0XFF151b54),
